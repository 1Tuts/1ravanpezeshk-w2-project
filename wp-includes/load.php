...
function wp_unregister_GLOBALS() {
	...
	if ( isset( $_REQUEST['GLOBALS'] ) )
		die( /*WP_I18N_GLOBALS_OVERWRITE*/'تلاش برای بازنویسی GLOBALS شناسایی شد'/*/WP_I18N_GLOBALS_OVERWRITE*/ );
...
function wp_check_php_mysql_versions() {
	...
	if ( version_compare( $required_php_version, $php_version, '>' ) )
		die( sprintf( /*WP_I18N_OLD_PHP*/'سرویس‌دهنده‌ی شما نگارش PHP %1$s را اجرا می‌کند در صورتی‌که وردپرس %2$s نیاز به نگارش %3$s و بالاتر از آن دارد..'/*/WP_I18N_OLD_PHP*/, $php_version, $wp_version, $required_php_version ) );

	if ( !extension_loaded( 'mysql' ) && !file_exists( WP_CONTENT_DIR . '/db.php' ) )
		die( /*WP_I18N_OLD_MYSQL*/'سرویس MySQL که مورد نیاز وردپرس است بر روی سرویس‌دهنده‌ی شما نصب نیست.'/*/WP_I18N_OLD_MYSQL*/ );
}
...
?>
	...
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<title><?php echo /*WP_I18N_MAINTENANCE*/'در دست تعمیر'/*/WP_I18N_MAINTENANCE*/; ?></title>

	</head>
	<body>
		<h1><?php echo /*WP_I18N_MAINT_MSG*/'جهت انجام عملیات تعمیرات زمان‌بندی شده برای مدت کوتاهی در دسترس نیست. یک دقیقه دیگر مراجعه کنید.'/*/WP_I18N_MAINT_MSG*/; ?></h1>
	</body>
	</html>
<?php
	die();
...
function wp_set_wpdb_vars() {
	...
	if ( is_wp_error( $prefix ) )
		wp_die( /*WP_I18N_BAD_PREFIX*/'<strong>خطا</strong>: <code>$table_prefix</code> در پرونده <code>wp-config.php</code> تنها می‌تواند شامل اعداد٬ حروف و زیرخط‌ها باشد.'/*/WP_I18N_BAD_PREFIX*/ );
}
